...
function App() {
  return (
    <div className="App">
      <Card 
      id={data["python"][0]["id"]} image={data["python"][0]["image"]} title={data["python"][0]["title"]}
      author={data["python"][0]["author"]} rating={data["python"][0]["rating"]} people={data["python"][0]["people"]}
      price={data["python"][0]["price"]} bestSeller={data["python"][0]["bestSeller"]}>
      </Card>
    </div>
  );
}
