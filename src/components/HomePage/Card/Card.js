...
function Card(props) {
    ...
    const reFormatTitle = (title) =>
        title.length > 38 ? title.substring(0, 37) + "..." : title;
                        ...
                        >
                            <article className={style.coursesGridItem}>
                                ...
                                <header style={{ padding_left: "12px" }}>
                                    ...
                                    >
                                        {reFormatTitle(courseData["title"])}
                                    </h3>
                                    <p
                                        className={
                                            style.couresGridItemDescription
                                        }
                                        style={{ color: "#876f89" }}
                                    >
                                        {reFormatAuthors(
