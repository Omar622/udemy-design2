...
function Card(props) {
    const {courseData, courseSectionsData, reviews} = props;
    ...
    return <Link to="courses" state={{courseData: courseData, courseSectionsData: courseSectionsData, reviews: reviews}} style={{textDecoration: 'none', color: 'black'}}>
