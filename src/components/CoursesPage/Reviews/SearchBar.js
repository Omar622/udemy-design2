...
function SearchBar() {
    return <div style={{display: "flex"}}>
        <form style={{border: "1px solid black", width: "422px"}}>
            <input  type={"text"} name="search" placeholder="Search reviews" style={{border: "none", padding: "0px 20px", height: "38px", width: "380px"}}/>
            <button type={"submit"} style={{backgroundColor: "#1C1D1F", height: "40px"}}>
