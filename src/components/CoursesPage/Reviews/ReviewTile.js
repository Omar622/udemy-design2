...
function ReviewTile(props) {
    ...
    return <>
        <div style={{display: "flex"}}>
            <div>
                <img src={image} className="rounded-circle" style={{width: "38px"}} alt="Avatar" />
            </div>
            ...
            <div>
                ...
                <span style={{display: "flex"}}>
                    ...
                    <p style={{fontSize: "10px", color: "#83878A"}}>{time_since}</p>
                </span>
                <p style={{fontSize: "13px"}}>{content}</p>
                <p style={{fontSize: "10px", color: "#83878A"}}>Was his review helpful?</p>
                <div style={{display: "flex"}}>
                    <div className={style.likeAvatar}>
                        <ThumbUpOutlinedIcon style={{width: "20px"}}/>
                    </div>
                    <div className={style.likeAvatar}>
                        <ThumbDownOffAltOutlinedIcon style={{width: "20px"}}/>
                    </div>
                    <p style={{fontSize: "12px", textDecoration: "underline", margin: "auto 0px"}}>Report</p>
                </div>
            </div>
        </div>
