  ...
  return (
    <div className={style.container}>
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: "0px" }}>
            <li style={{ fontSize: "14px" }}>
              <OndemandVideoIcon style={{ width: "15px" }} />{" "}
              {reFormatTime(time)[0]} hours on-demand video
            </li>
            <li style={{ fontSize: "14px" }}>
              <DescriptionOutlinedIcon style={{ width: "15px" }} /> 1 article
            </li>
            <li style={{ fontSize: "14px" }}>
              <SystemUpdateAltIcon style={{ width: "15px" }} /> 3 downloadable
              resources
            </li>
            <li style={{ fontSize: "14px" }}>
              <AllInclusiveOutlinedIcon style={{ width: "15px" }} /> Full
              lifetime access
            </li>
            <li style={{ fontSize: "14px" }}>
              <StayCurrentPortraitOutlinedIcon style={{ width: "15px" }} />{" "}
              Access on mobile and TV
            </li>
            <li style={{ fontSize: "14px" }}>
              <EmojiEventsOutlinedIcon style={{ width: "15px" }} /> Certificate
              of completion
            </li>
          </ul>
        </div>
      ...
      <div style={{ padding: "20px" }}>
        ...
        <button className={style.tryUdemyBusinessBtn}>
          Try Udemy Business
        </button>
      </div>
    </div>
