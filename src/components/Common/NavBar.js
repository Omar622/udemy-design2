...
function NavBar() {
    ...
    return (
        <header className={style.navBar}>
            ...
            <form
                className={style.navBarInput + " " + style.navBarItem}
                onSubmit={handleFormSubmitted}
            >
                <input
                    className={style.pcView + " " + style.navBarInputText}
                    type={"text"}
                    name="search"
                ...
                />
                <button
                    className={style.pcView + " " + style.transparentButton}
                    type={"submit"}
                >
                    <SearchRoundedIcon />
                </button>
            ...
            {/* shopping button */}
            <button
                className={style.transparentButton + " " + style.navBarItem}
            >
